...
class GoogleSheetsService:
    ...
    def client_to_row(self, client: Dict) -> List:
        ...
        return [
            ...
            client.get('codFortesFs', ''),
            client.get('codFortesPs', ''),
            client.get('codDominio', ''),
    ...
    def row_to_client(self, row: List) -> Dict:
        ...
        return {
            ...
            'fs': get_cell(3) == 'SIM',
            'dp': get_cell(4) == 'SIM',
            'codFortesCt': get_cell(5),
            'codFortesFs': get_cell(6),
            'codFortesPs': get_cell(7),
            'codDominio': get_cell(8),
